...
const CustomSoundControls = () => {
    ...
    return (
        <div className="bg-zinc-900 p-5 rounded-xl mb-8 border border-zinc-800 shadow-lg h-full w-full flex flex-col">
            <div className="flex items-center gap-2 mb-5">
                <Music className="w-5 h-5 text-red-500" />
                <h2 className="text-lg font-bold text-white">Sound Control</h2>
            </div>
